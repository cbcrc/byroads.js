...
describe('urlParser.parse()', function(){
    ...
    afterEach(function(){
        ...
        urlParser.routed.removeAll();
        urlParser.bypassed.removeAll();
    ...
    describe('simple string route', function(){
        ...
        it('shold route basic strings', function(){
            ...
            urlParser.addRoute('/foo', function(a){
                t1++;
            });
            urlParser.parse('/bar');
            urlParser.parse('/foo');
        ...
        it('should pass params and allow multiple routes', function(){
            ...
            urlParser.addRoute('/{foo}/{bar}', function(foo, bar){
                t2 = foo;
                t3 = bar;
            });
            urlParser.parse('/lorem_ipsum');
            urlParser.parse('/maecennas/ullamcor');
    ...
    describe('optional params', function(){
        ...
        it('should capture optional params', function(){
            ...
            urlParser.parse('foo/lorem/123/true/false');
    ...
    describe('typecast values', function(){
        ...
        it('should typecast values if shouldTypecast is set to true', function(){
            ...
            urlParser.parse('lorem/123/true/false/null/undefined');
        ...
        it('should not typecast if shouldTypecast is set to false', function(){
            ...
            urlParser.parse('lorem/123/true/false');
    ...
    describe('rules.normalize_', function(){
        ...
        it('should normalize params before dispatching signal', function(){
            ...
            urlParser.parse('news/111/lorem-ipsum');

            myRoute.matched.addOnce(function(a, b){
                t3 = a;
                t4 = b;
            });
            urlParser.parse('news/foo/222/lorem-ipsum');

            myRoute.matched.addOnce(function(a, b){
                t5 = a;
                t6 = b;
            });
            urlParser.parse('news/333');

            myRoute.matched.addOnce(function(a, b){
                t7 = a;
                t8 = b;
            });
            urlParser.parse('article/news/444');
    ...
    describe('validate params before dispatch', function(){
        ...
        it('should ignore routes that don\'t validate', function(){
            ...
            urlParser.parse('45-ullamcor'); //first so we make sure it bypassed route `a`
            urlParser.parse('123-ullamcor');
            urlParser.parse('lorem-123');
            urlParser.parse('lorem-555');
    ...
    describe('default arguments', function () {
        ...
        it('should pass default arguments to all signals', function () {
            ...
            urlParser.parse('foo', [123, 'dolor']);
            urlParser.parse('bar', ['ipsum', 123]);
    ...
    describe('rest params', function () {
        ...
        it('should pass rest as a single argument', function () {
            ...
            urlParser.parse('news/456/foo/bar');
            ...
            urlParser.parse('news/456/123/aaa/bbb');
        ...
        it('should work in the middle of segment as well', function () {
            ...
            urlParser.parse('article/333/add');
            ...
            urlParser.parse('news/456/foo/bar/edit');
        ...
        it('should handle multiple rest params even though they dont make sense', function() {
            ...
            urlParser.parse('news/456/foo/bar/this/the/end');
            urlParser.parse('news/456/foo/bar/this/is/crazy/long/the/end');
            urlParser.parse('article/weather/rain-tomorrow/the/end');
    ...
    describe('query string', function () {
        ...
        describe('old syntax', function () {
            it('should only parse query string if using special capturing group', function () {
                ...
                urlParser.parse('foo.php?foo=bar&lorem=123#bar');
        ...
        describe('required query string after required segment', function () {
            it('should parse query string into an object and typecast vals', function () {
                ...
                urlParser.parse('foo.php?lorem=ipsum&asd=123&bar=false');
        ...
        describe('required query string after optional segment', function () {
            it('should parse query string into an object and typecast vals', function () {
                ...
                urlParser.parse('?lorem=ipsum&asd=123');
